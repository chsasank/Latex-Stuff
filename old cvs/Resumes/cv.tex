...
\section{Key Courses}
\cvitem{Electical Engineering}{Information Theory, Error Correcting Codes, Stochastic Optimisation, Digital Signal Processing, Digital Communications, Advanced Probability and Random Processes}
\cvitem{Computer Science}{Computer Vision, Algorithms for Medical Image Processing,  Convex Optimization, Machine Learning, Digital Image Processing, Data structures \& Algorithms}
\cvitem{Mathematics}{Graph Theory, Quantum Information and Computing, Real Analysis, Complex Analysis, Fourier Analysis, Abstract Algebra}
