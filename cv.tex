...
To combat high phase noise from lasers in coherent optical communication systems, we have to use specialized signal constellations and coding schemes. How do various such phase noise optimized constellations stack up when used along with proposed Multi-Level Coded Modulation (MLCM) heuristics?
\begin{itemize}
...
\cvitem{Dec 2013}{\textbf{Indo-European Winter Academy, IIT Guwahati} : \textbf{One of 5} selected to represent IIT Bombay. Presented a 1-hour seminar on Optoelectronic Emitters covering physical principles and devices}

\cvitem{Jan 2014}{\textbf{ITCSC-INC Winter School 2014, CUHK, Hong Kong} : One of 14 invited from India. Topics covered include Information Theory and Fourier transform for binary functions}
